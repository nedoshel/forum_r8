...
class ChatMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_message" do
    assert_difference("ChatMessage.count") do
      post chat_messages_url, params: { chat_message: { chat_id: @chat_message.chat_id, content: @chat_message.content, user_id: @chat_message.user_id } }
    end
  ...
  test "should update chat_message" do
    patch chat_message_url(@chat_message), params: { chat_message: { chat_id: @chat_message.chat_id, content: @chat_message.content, user_id: @chat_message.user_id } }
